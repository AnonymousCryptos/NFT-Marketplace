...
A decentralized NFT marketplace built on an EVM-based network and written in the Solidity language that supports NFT creation, auctions, offers, Fixed price sale, and time-based drops.
...
- 100% test coverage with all positive & negative scenarios covered
