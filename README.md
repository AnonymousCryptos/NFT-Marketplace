...
A decentralized NFT marketplace built on an EVM-based network and written in the Solidity language that supports NFT creation, auctions, offers, Fixed price, and time-based drops.
